...
# Chunks the ROI into 5x5=25 blocks 
...
def get_haarcascade():
    ...
    if haarcascade_filename not in os.listdir(os.curdir):
...
def get_eye_cascade():
    ...
    # chech if file is in working directory
    if eye_cascade_filename not in os.listdir(os.curdir):
    ...
    for idx, frame in enumerate(frames):
       ...
       # step 1
        ...
        if len(faces) != 0:
            ...
            # print(f"face detection failed, image frame will be masked. frame {idx}")
...
if __name__ == '__main__':
    # get_frames_and_video_meta_data('cpi_gym.avi')
    ...
    video_path = 'data/test/cpi_rotation.avi'
    get_spatio_temporal_map_threaded(video_path)
